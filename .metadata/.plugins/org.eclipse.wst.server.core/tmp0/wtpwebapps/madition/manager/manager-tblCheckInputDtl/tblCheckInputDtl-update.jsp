...
function update() {
	...
	var valus = document.getElementsByName("memos1");
	  ...
	  parms["tblCheckInputInfo.chk1or2"] = $("input[name='flag']:checked").val();
	  parms["tblCheckInputInfo.memos"] = str1;
	  parms["tblCheckInputInfo.projids"] = str3;
	  parms["tblCheckInputInfo.remark"] = $("#remark").val();
	  parms["tblCheckInputInfo.memos1"] = str2;
	  parms["tblCheckInputInfo.projids1"] = str4;
	  parms["tblCheckInputInfo.remark1"] = $("#remark1").val();
	  /* if($("input[name='flag']:checked").val()==1){
		  parms["tblCheckInputInfo.memos"] = str1;
		  parms["tblCheckInputInfo.projids"] = str3;
		  parms["tblCheckInputInfo.remark"] = $("#remark").val();
	  }else if($("input[name='flag']:checked").val()==2){
		  parms["tblCheckInputInfo.memos"] = str2;
		  parms["tblCheckInputInfo.projids"] = str4;
		  //parms["tblCheckInputInfo.doctormemo"] = $("#doctormemo1").val();
		  parms["tblCheckInputInfo.remark"] = $("#remark1").val();
	  } */
	  $.ajax({
			type : 'POST',
			url: '<%=basePath%>hos/tblCheckInputInfo_update.action',
			data: parms,
			dataType:'json',
			success: function(json){
				if(json.resultCode=='0'){
...
function findNextStu(){
	//window.location.reload();
	 ...
	 $.ajax({
			type : 'POST',
			url: '<%=basePath%>hos/tblCheckInputInfo_findNextStudent.action?id='+id+'&id2='+id2,
			dataType:'json',
			beforeSend:function(){
